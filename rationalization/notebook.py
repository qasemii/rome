...
if calculate_new:
    ...
    tokenizer = AutoTokenizer.from_pretrained(args.model_name, cache_dir='../ReAGent/cache')
    model = AutoModelForCausalLM.from_pretrained(args.model_name, cache_dir='../ReAGent/cache').to(device)
